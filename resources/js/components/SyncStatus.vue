<template>
    <div class="fixed bottom-4 right-4 z-50">
        ...
        <div v-if="showSyncStatus"
            ...
            <!-- Sync Button -->
            <button @click="handleSync" :disabled="!isOnline || isSyncing || pendingCount === 0"
            ...
            <div class="mt-3 flex gap-2">
                <button @click="showPendingTransactions = !showPendingTransactions"
            ...
            <div v-if="showPendingTransactions && pendingTransactions.length > 0" class="mt-3 border-t pt-3">
                ...
                <div class="max-h-32 overflow-y-auto space-y-2">
                    <div v-for="transaction in pendingTransactions" :key="transaction.offline_id"
        ...
        <button v-if="!showSyncStatus && (pendingCount > 0 || !isOnline)" @click="showSyncStatus = true"
            ...
            <!-- Offline indicator -->
            <span v-if="!isOnline" class="absolute -bottom-1 -right-1 bg-red-500 rounded-full h-3 w-3"></span>
        </button>

        <!-- Toggle visibility button -->
        <button v-if="showSyncStatus" @click="showSyncStatus = false"
